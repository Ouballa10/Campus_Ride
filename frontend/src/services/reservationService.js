...
async function updateReservationStatus({
  ...
  if (reservationError) {
    throw formatSupabaseError(reservationError, "Impossible de charger la reservation.");
  }
  ...
  if (!trajet || trajet.conducteur_id !== conducteurId) {
    throw new Error("Seul le conducteur du trajet peut confirmer cette reservation.");
  }
